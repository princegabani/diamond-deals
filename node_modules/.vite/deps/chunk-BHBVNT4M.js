...
function StyledEngineProvider(props) {
  ...
  const cache = React4.useMemo(() => getCache(injectFirst, enableCssLayer), [injectFirst, enableCssLayer]);
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime10.jsxs)(React19.Fragment, {
  ...
  const Grid2 = React21.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime12.jsx)(GridRoot, {
      ...
      children: React21.Children.map(children, (child) => {
        var _a;
        if (React21.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-BHBVNT4M.js.map
