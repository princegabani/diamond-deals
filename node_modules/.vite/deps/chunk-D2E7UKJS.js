...
} from "./chunk-P56J4YKZ.js";
import {
  MenuList_default
} from "./chunk-Z7PS2LXZ.js";
import {
  PopoverPaper,
  Popover_default
} from "./chunk-2YFE7Y4W.js";
import {
  Input_default
} from "./chunk-3Z5KONXZ.js";
import {
  ArrowDropDown_default,
  filledInputClasses_default,
  getFilledInputUtilityClass
} from "./chunk-G263EHRP.js";
import {
  InputBaseInput,
  InputBaseRoot,
  InputBase_default,
...
} from "./chunk-OBP6NYDI.js";
import {
  useControlled_default
} from "./chunk-OZVANB7Z.js";
import {
  useForkRef_default
} from "./chunk-VB7K6UN4.js";
import {
  createSimplePaletteValueFilter
} from "./chunk-ZCSSBJ3Q.js";
import {
  capitalize_default
} from "./chunk-2NQVPKE4.js";
import {
  memoTheme_default
...
var NativeSelectInput = React3.forwardRef(function NativeSelectInput2(props, ref) {
  const {
    className,
    disabled,
    error,
  ...
  return (0, import_jsx_runtime3.jsxs)(React3.Fragment, {
    children: [(0, import_jsx_runtime3.jsx)(NativeSelectSelect, {
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref,
      ...other
    }), props.multiple ? null : (0, import_jsx_runtime3.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
true ? NativeSelectInput.propTypes = {
   ...
   */
  IconComponent: import_prop_types3.default.elementType.isRequired,
  /**
   ...
   * The variant to use.
   */
  variant: import_prop_types3.default.oneOf(["standard", "outlined", "filled"])
} : void 0;
...
var SelectInput = React4.forwardRef(function SelectInput2(props, ref) {
  var _a;
  const {
  ...
  const displayRef = React4.useRef(null);
  const [displayNode, setDisplayNode] = React4.useState(null);
  const {
    current: isOpenControlled
  } = React4.useRef(openProp != null);
  const [menuMinWidthState, setMenuMinWidthState] = React4.useState();
  const handleRef = useForkRef_default(ref, inputRefProp);
  const handleDisplayRef = React4.useCallback((node) => {
  ...
  React4.useImperativeHandle(handleRef, () => ({
    focus: () => {
  ...
  return (0, import_jsx_runtime4.jsxs)(React4.Fragment, {
    children: [(0, import_jsx_runtime4.jsx)(SelectSelect, {
      as: "div",
    ...
    }), (0, import_jsx_runtime4.jsx)(SelectNativeInput, {
      "aria-invalid": error,
      ...
      ...other,
      ownerState
    }), (0, import_jsx_runtime4.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime4.jsx)(Menu_default, {
      id: `menu-${name || ""}`,
...
true ? SelectInput.propTypes = {
   ...
   */
  autoWidth: import_prop_types4.default.bool,
  /**
   * The option elements to populate the select with.
   ...
   */
  displayEmpty: import_prop_types4.default.bool,
  /**
   * If `true`, the `select input` will indicate an error.
   */
   ...
   */
  MenuProps: import_prop_types4.default.object,
  /**
   ...
   * @returns {ReactNode}
   */
  renderValue: import_prop_types4.default.func,
  /**
   ...
   */
  SelectDisplayProps: import_prop_types4.default.object,
  /**
   * @ignore
   */
   ...
   * @ignore
   */
  type: import_prop_types4.default.any,
  /**
   * The input value.
   */
...
var Select = React5.forwardRef(function Select2(inProps, ref) {
  const props = useDefaultProps({
    name: "MuiSelect",
    props: inProps
  });
  ...
  const InputComponent = input || {
    standard: (0, import_jsx_runtime5.jsx)(StyledInput, {
      ownerState
    }),
    outlined: (0, import_jsx_runtime5.jsx)(StyledOutlinedInput, {
      label,
      ownerState
    }),
    filled: (0, import_jsx_runtime5.jsx)(StyledFilledInput, {
      ownerState
    })
  }[variant];
  ...
  return (0, import_jsx_runtime5.jsx)(React5.Fragment, {
    children: React5.cloneElement(InputComponent, {
...
true ? Select.propTypes = {
   ...
   */
  IconComponent: import_prop_types5.default.elementType,
  /**
   ...
   */
  input: import_prop_types5.default.element,
  /**
   * [Attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#Attributes) applied to the `input` element.
   ...
   * @default false
   */
  native: import_prop_types5.default.bool,
  /**
   * Callback fired when a menu item is selected.
   *
   ...
   */
  value: import_prop_types5.default.oneOfType([import_prop_types5.default.oneOf([""]), import_prop_types5.default.any]),
  /**
   * The variant to use.
   * @default 'outlined'
   */
...
//# sourceMappingURL=chunk-D2E7UKJS.js.map
