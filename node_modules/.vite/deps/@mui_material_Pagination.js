...
var PaginationItem = React3.forwardRef(function PaginationItem2(inProps, ref) {
  ...
  return type === "start-ellipsis" || type === "end-ellipsis" ? (0, import_jsx_runtime3.jsx)(PaginationItemEllipsis, {
    ...
    children: "…"
  }) : (0, import_jsx_runtime3.jsxs)(PaginationItemPage, {
    ref,
    ownerState,
    component,
    disabled,
    className: clsx_default(classes.root, className),
    ...other,
    children: [type === "page" && page, IconSlot ? (0, import_jsx_runtime3.jsx)(PaginationItemPageIcon, {
      ...iconSlotProps,
...
var Pagination = React4.forwardRef(function Pagination2(inProps, ref) {
  ...
  const {
    ...
    onChange,
    page,
    renderItem = (item) => (0, import_jsx_runtime4.jsx)(PaginationItem_default, {
      ...item
    }),
    shape = "circular",
    showFirstButton = false,
  ...
  return (0, import_jsx_runtime4.jsx)(PaginationRoot, {
    "aria-label": "pagination navigation",
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other,
    children: (0, import_jsx_runtime4.jsx)(PaginationUl, {
      className: classes.ul,
      ownerState,
      children: items.map((item, index) => (0, import_jsx_runtime4.jsx)("li", {
        children: renderItem({
          ...item,
          color,
